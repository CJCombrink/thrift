...
#include "gen-cpp/ThriftTest_types_cpp17.h"
...
class TestHandler : public ThriftTestIf {
  ...
  void testInsanity(map<UserId, map<Numberz,Insanity> > &insane, const Insanity &argument) override {
  ...
  void testMulti(Xtruct &hello, const int8_t arg0, const int32_t arg1, const int64_t arg2, const std::map<int16_t, std::string>  &arg3, const Numberz arg4, const UserId arg5) override {
...
// #endif
    ...
    auto socket = std::make_shared<apache::thrift::transport::TSocket>("localhost", TEST_PORT);
    auto protocol = std::make_shared<apache::thrift::protocol::TBinaryProtocol>(socket);
